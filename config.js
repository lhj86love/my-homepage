...
const SITE = {
  ...
  worries: [
    ...
    {
      q: "시안이 하나도 마음에 안 들면요?",
      a: "납품 전까지는 수정 횟수를 세지 않습니다. 방향 자체가 안 맞으면 처음부터 다시 제안드립니다.",
    },
    {
  ...
  */
  ...
  priceNote: "작업 범위에 따라 달라질 수 있어, 정확한 금액은 상담 후 알려드립니다.",

  services: [
    {
      title: "심플",
      price: "4만 9천원부터",
      desc: "가게 이름만 있으면 되는 분께.",
      items: [
        "글자형(워드마크) 로고 1종",
        "시안 2종 제안",
        "작업 5일 (협의 가능)",
    ...
    },
    {
      ...
      price: "15만원부터",
      best: true,
      desc: "간판부터 명함까지 한 번에 정리하고 싶은 분께. 대부분 이 구성을 선택하십니다.",
      items: [
        "심볼 + 글자형 로고",
        "시안 3종 제안",
        "가로형·세로형·흑백 응용형 포함",
    ...
    },
    {
      title: "브랜드 패키지",
      price: "30만원부터",
      desc: "간판, 포장, SNS까지 하나의 톤으로 맞추고 싶은 분께.",
      items: [
        "스탠다드 구성 전부 포함",
        "색상·서체 사용 가이드",
        "SNS 프로필·썸네일",
  ...
  /* 가격표 아래에 작게 붙는 안내 */
  priceFootnote:
    "최종 파일을 납품한 뒤의 수정은 진행하지 않습니다. " +
    "부득이하게 필요한 경우 별도 협의 후 추가 비용이 발생할 수 있습니다.",

  /* 추가 옵션 */
  priceOptions: [
    { name: "명함만 따로", price: "5만원부터" },
    { name: "급행 (3일 이내)", price: "+5만원" },
    { name: "시안 추가", price: "3만원" },
    { name: "인쇄 대행 (200매~)", price: "실비" },
  ],
